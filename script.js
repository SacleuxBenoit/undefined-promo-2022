...
async function fetchStudents ()
{
	...
	students.forEach( student => {
		...
		if(student.lastname && student.firstname && student.sex == "M"){
			card.className = "text-blue-800 text-lg leading-tight font-medium mb-8 border bg-slate-900 w-3/4 ml-20 pl-4 pt-2 text-center";
			card.innerHTML = student.lastname + " " + student.firstname;
		}else if(student.lastname && student.firstname && student.sex == "F"){
			card.className = "text-pink-800 text-lg leading-tight font-medium mb-8 border bg-slate-900 w-3/4 ml-20 pl-4 pt-2 text-center";
			card.innerHTML = student.lastname + " " + student.firstname;
